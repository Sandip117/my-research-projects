...
public class MossApi {
	...
	public List<PlagiarismStorer> getPlagiarism(String filePath) throws MossException {
		URL url = getMossURL(filePath);
	...
	public URL getMossURL(String filePath) throws MossException {
		...
		Collection<File> files = FileUtils.listFiles(new File(filePath), new String[]{"py"}, true);
