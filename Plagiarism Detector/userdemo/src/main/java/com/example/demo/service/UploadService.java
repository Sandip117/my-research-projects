...
public class UploadService {
    ...
    public boolean uploadFiles(MultipartFile[] files, String assignmentName, String studentName, String courseName, String semName, String subId){

        String dirPath = String.format("%s%s/%s/%s/%s/%s", PATH, semName, courseName, assignmentName, studentName, subId);
        LOGGER.info("Im in!");
        LOGGER.info(dirPath);
